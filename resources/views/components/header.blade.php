    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a href="{{ route('welcome') }}" class="header-logo">
                <img class="logo" src="{{ asset('image/broobe.png') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mx-2 mb-lg-0">
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="{{ route('metrics.index') }}">Run Metrics</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="{{ route('about.metrics') }}">About Metrics</a>
                    </li>
                </ul>
            </div>
        </div>
